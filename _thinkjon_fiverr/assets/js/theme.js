...
jQuery(document).ready(function( $ ) {
    ...
    // Magnific Gallery for Videos Popup (Manos)
    // ======================
    jQuery(document).ready(function( $ ) {

      $('.magnific-videos').each(function(index , value){
          var gallery = $(this);
          var galleryVideos = $(this).data('links').split(',');
          var items = [];
          for(var i=0;i<galleryVideos.length; i++){
              items.push({
                  src:galleryVideos[i],
                  title:''
              });
  ...
  // CodePen Home Delegate inline items in Magnific Popup
  //https://codepen.io/dimsemenov/pen/zvLny
    ...
    // ======================
/*
    $('#open-2020').magnificPopup({
        mainClass: 'mfp-fade',
        items: [
          {
            src: '<div style="width 400px; hieght:1200px; backgroundColor: #ccc;"><a href="open-digital-signage-stills"><div style="width 150px; hieght:300px; backgroundColor: #eee;"">Menu Stills<div></a>
            <a href="open-digital-signage-reel"><div style="width 150px; hieght:300px; backgroundColor: #eee;">Demo Reel<div></a><a href="#"><div style="width 150px; hieght:300px; backgroundColor: #eee;"">thinimg 01<div></a></div>', // HTML string
            type: 'inline'
          },
          {
            src: 'https://www.thinkjon.com/new-js-code/assets/images/portfolio/img-work01-normal.jpg',
            title: 'Image Slide 01'
          },
                {
            src: 'https://www.thinkjon.com/new-js-code/assets/images/portfolio/img-work02-normal.jpg',
            title: 'Image Slide 02'
          },
          {
